...
Revision ID: 8b21b0bc495b
Revises: 
Create Date: 2021-11-01 11:38:35.573164
...
def upgrade():
    ...
    op.create_table('ih_order_info',
                    ...
                    sa.Column('status',
                              sa.Enum('WAIT_ACCEPT', 'WAIT_PAYMENT', 'PAID', 'WAIT_COMMENT', 'COMPLETE', 'CANCELED',
